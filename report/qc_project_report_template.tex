...
\pagestyle{fancy}
\fancyhf{}
\IfFileExists{ku_logo.jpg}{\fancyhead[L]{\includegraphics[height=20pt]{ku_logo.jpg}}}{\fancyhead[L]{}}%
...
\begin{titlepage}
  ...
  {\Large\textbf{Quantum Reinforcement Learning for Grid World Navigation: A Comparative Analysis}}\\[16pt]
    ...
    {\textcolor{placeholder}{Prepared by}}\\[8pt]
    {\large Barış Cem Bakay}\\[4pt]
    {\large 0082990}\\[30pt]

    \placeholder{Date: }{May 31, 2026}\\[60pt]
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|L{4.0cm}|X|}
        ...
        \hline
        \rowcolor{darkred!20}
        Variables & Agent state coordinate vector $s = (x, y) \in [0, N-1]^2$; action $a \in \{0, 1, 2, 3\}$ (representing Up, Down, Left, Right); reward $r \in \mathbb{R}$. \\
        \hline
